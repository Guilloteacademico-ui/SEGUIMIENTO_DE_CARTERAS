...
Aplicación web estilo iOS para gestionar carteras de inversión en acciones, con cotizaciones en tiempo real de Finnhub API.

## ✨ Diseño

Inspirado en **Apple Stocks**, **Wallet** y el sistema de diseño de **iOS 18/26**:
- 🎨 Glassmorphism y blur effects nativos
- 📱 Componentes iOS auténticos (toggle, modals, FAB)
- ✨ Animaciones suaves y micro-interacciones
- 🌊 Safe areas y Dynamic Island aware
